...
class VerifyCodeWidget extends StatelessWidget {
   VerifyCodeWidget({super.key,required this.logic, this.isRegister=true});
  final formKey = GlobalKey<FormState>();

 final AuthController logic;
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 30.w, vertical: 8.h),
            child: Text(
              logic.formatter.apply("966${logic.phoneNum}"),
          ...
          Ui.primaryButton(
              ...
              onTab: () {
                ...
                logic.verifyCode(isRegister: isRegister);
              }),
          Row(
